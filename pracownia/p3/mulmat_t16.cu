...
__global__ void MulMatrixKernel2_T16(
...
// pamieci globalnej
__global__ void MulMatrixKernel3_T16(float* A, float* B, float* C, int N)   // jądro - kernel
{
...
extern "C" void GPUMatrixMul_T16 (float *A, float *B, float *C, int N) {
    ...
    MulMatrixKernel2_T16<<<dimGrid, dimBlock>>>(Ad,Bd,Cd,N);
